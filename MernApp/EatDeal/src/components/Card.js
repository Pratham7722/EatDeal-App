      ...
      <div className="card mt-3" style={{ width: "16rem", maxHeight: "360px" }}>
        ...
        <div className="card-body">
          ...
          <div className='container w-100 p-0' style={{ height: "38px" }}>
            <select className="m-2 h-100 w-20 bg-primary text-black rounded" style={{ select: "#FF0000" }} onClick={handleClick} onChange={handleQty}>
          ...
          {/* <button className={`btn btn-primary justify-center ms-2 ${btnEnable ? "" : "disabled"}`} onClick={handleRemoveCart}>Remove</button> */}
        </div>
      </div>
    </div>
  )
